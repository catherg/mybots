...
Curves of the highest fitness value plotted over 100 generations of 5 different creatures. The population size also differs among these creatures, with
first creature having a population size of 1, the second creature having a population size od 2, etc.
